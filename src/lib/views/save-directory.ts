 ...
 * marking — the second would leave a permanent mark next to a button that cannot achieve anything,
 * because {@link grantSaveDirectory} answers `denied` for it on sight.
 */
